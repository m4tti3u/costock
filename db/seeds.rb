...
collectible4 = Collectible.create!(category: 'cards', brand: 'Pokemon', model: 'Dracofeu 1st edition', reference: 'PK-DCF-1ST-PGA10', retail_price: 1.0, resell_value: 500000.0, description: 'Une carte mythique pour toutes les générations fans de Pokemon dans un état immaculé', nft_number: 10000, user_id: '3')
...
collectible5 = Collectible.create!(category: 'cards', brand: 'Pokemon', model: 'Blastoise 1st edition', reference: 'PK-BST-1ST-PGA8.5', retail_price: 1.0, resell_value: 12408.0, description: 'Une carte mythique pour toutes les générations fans de Pokemon dans un état immaculé', nft_number: 1000, user_id: '3')
...
collectible6 = Collectible.create!(category: 'cards', brand: 'Panini Revolution', model: '2019-20 Revolution Infinite Holographic Kobe Bryant', reference: 'PZ-KB-HOLO', retail_price: 10.0, resell_value: 18090.1, description: 'Une carte magnifique', nft_number: 1000, user_id: '3')
...
collectible7 = Collectible.create!(category: 'cards', brand: 'Pokemon', model: 'Booster Pack 1st edition', reference: 'PK-BSTR-1ST', retail_price: 19.0, resell_value: 488.9, description: 'Un paquet de cartes Pokemon dans un état immaculé', nft_number: 100, user_id: '3')
