...
collectible1 = Collectible.create!(category: 'Sneakers', brand: 'Nike', model: 'TravisXFragment', reference: 'NK-AJ1-TS-FRG', retail_price: 180.0, resell_value: 2488.9, description: 'Une paire révolutionnaire melant la créativité de 3 artistes de génies', nft_number: 1000, user_id: '3', validation: true)
...
collectible2 = Collectible.create!(category: 'Sneakers', brand: 'Adidas', model: 'NMDXChanel', reference: 'AD-NMD-CH', retail_price: 200.0, resell_value: 5367.9, description: 'Une paire révolutionnaire melant la créativité de 3 artistes de génies', nft_number: 100, user_id: '3', validation: true)
...
collectible3 = Collectible.create!(category: 'Sneakers', brand: 'Nike', model: 'AJ185 Chicago', reference: 'NK-AJ1-CH-1985', retail_price: 60.0, resell_value: 5200.0, description: 'Une paire révolutionnaire melant la créativité de 3 artistes de génies', nft_number: 100, user_id: '3', validation: true)
...
collectible4 = Collectible.create!(category: 'Cartes', brand: 'Pokemon', model: 'Dracofeu 1st ed.', reference: 'PK-DCF-1ST-PGA10', retail_price: 1.0, resell_value: 500000.0, description: 'Une carte mythique pour toutes les générations fans de Pokemon dans un état immaculé', nft_number: 10000, user_id: '3', validation: true)
...
collectible5 = Collectible.create!(category: 'Cartes', brand: 'Pokemon', model: 'Blastoise 1st ed.', reference: 'PK-BST-1ST-PGA8.5', retail_price: 1.0, resell_value: 12408.0, description: 'Une carte mythique pour toutes les générations fans de Pokemon dans un état immaculé', nft_number: 1000, user_id: '3', validation: true)
...
collectible6 = Collectible.create!(category: 'Cartes', brand: 'Panini Revolution', model: 'Infinite Holo KB', reference: 'PZ-KB-HOLO', retail_price: 10.0, resell_value: 18090.1, description: 'Une carte magnifique', nft_number: 1000, user_id: '3', validation: true)
...
collectible7 = Collectible.create!(category: 'Cartes', brand: 'Pokemon', model: 'Booster Pack 1st ed.', reference: 'PK-BSTR-1ST', retail_price: 19.0, resell_value: 488.9, description: 'Un paquet de cartes Pokemon dans un état immaculé', nft_number: 100, user_id: '3', validation: true)
